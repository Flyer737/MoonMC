...
### Building MoonMC on linux --MoonMC's edit
This is my method. I used GCC to build.

First, go to into the folder. (build and install folders are already made.)
```
cd MoonMC-master
```
...
### Building from command line (Regular MultiMC)
